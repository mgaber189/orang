          ...
          <div
            ...
            <div className="top-left">
              <p className="start-price start">
                Start from <br />
                <strong className="start-price"> 850 USD </strong>
              </p>
            </div>
            ...
            <div className="card-body">
              ...
              <p className="card-text text-primary">1000 USD Per Person</p>
              <p className="card-text text-primary">750 USD Per Children</p>
        ...
        <div className="col-md-4">
          <div
            ...
            <div className="card-body">
              ...
              <p className="card-text text-primary">500 USD Per Person</p>
              <p className="card-text text-primary">250 USD Per Person</p>
              <div className="rating">
                <span className="orange-star"></span>
                <span className="orange-star"></span>
                <span className="orange-star"></span>
